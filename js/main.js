...
const i18n = {
  zh: {
    ...
    'exp.detail.voucher': '凭证处理','exp.detail.report': '报表编制','exp.detail.payroll': '薪资管理',
    'exp.detail.data': '数据汇总','exp.detail.visit': '企业实地走访','exp.detail.contract': '清产核资与合同核查',
    'exp.detail.paper': '工作底稿辅助编制','exp.detail.acct': '账务处理','exp.detail.data2': '数据处理',
    'exp.detail.vtypes': '凭证类型','exp.detail.flow': '账务流程处理','exp.detail.tax': '多种税务申报',
    'exp.detail.cost': '成本核算分析',
    'exp.stat.vouchers': '处理业务凭证','exp.stat.accuracy': '财务数据准确率',
    'exp.stat.efficiency': '报表编制效率提升','exp.stat.visits': '实地走访企业',
    'exp.stat.contracts': '核查合同份数','exp.stat.anomalies': '发现合同异常',
    'exp.stat.prize': '特等奖','exp.stat.stmts': '三大报表编制','exp.stat.eff2': '效率提升',
    'exp.stat.docs': '处理原始凭证','exp.stat.taxes': '税种申报模拟',
    'exp.stat.cycle': '账务闭环','exp.stat.full': '全流程','exp.stat.national': '国家级',
  ...
  en: {
    ...
    'exp.detail.voucher': 'Voucher Processing','exp.detail.report': 'Financial Reporting','exp.detail.payroll': 'Payroll',
    'exp.detail.data': 'Data Aggregation','exp.detail.visit': 'On-Site Visits','exp.detail.contract': 'Asset & Contract Review',
    'exp.detail.paper': 'Working Paper Support','exp.detail.acct': 'Accounting','exp.detail.data2': 'Data Processing',
    'exp.detail.vtypes': 'Voucher Types','exp.detail.flow': 'Full-Cycle Accounting','exp.detail.tax': 'Multi-Tax Filing',
    'exp.detail.cost': 'Cost Analysis',
    'exp.stat.vouchers': 'Vouchers','exp.stat.accuracy': 'Accuracy',
    'exp.stat.efficiency': 'Efficiency','exp.stat.visits': 'Visits',
    'exp.stat.contracts': 'Contracts','exp.stat.anomalies': 'Anomalies',
    'exp.stat.prize': 'Grand Prize','exp.stat.stmts': 'Statements','exp.stat.eff2': 'Efficiency',
    'exp.stat.docs': 'Documents','exp.stat.taxes': 'Tax Types',
    'exp.stat.cycle': 'Closed Loop','exp.stat.full': 'Full Cycle','exp.stat.national': 'National',
    'contact.phone.val': '15083593021', 'contact.email.val': 'xyq197@qq.com',
    'match.score': '/ 100',
